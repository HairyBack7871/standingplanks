...
Optional shapeless crafting conversion (configurable)

Fully compatible with other Fabric mods and modded wood sets

Lightweight implementation using a single blockstate property

Zero registry bloat — no duplicate blocks, no ID conflicts
